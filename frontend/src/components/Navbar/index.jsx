...
//             <h2 className="text-xl md:text-2xl font-bold text-[#1a504c]">
//               Odisha Polyclinic
//               <sup className="text-xs ml-1 align-top">™</sup>
//             </h2>
//           </Link>
...
//             <Link to="/departments" className="hover:text-[#1a504c] transition">
//               Departments
//             </Link>
...
//             <Link to="/learning" className="hover:text-[#1a504c] transition">
//               Learning
//             </Link>

//             <Link to="/contact" className="hover:text-[#1a504c] transition">
//               Contact
//             </Link>
//           </div>
