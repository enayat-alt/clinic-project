          ...
          <div className="bg-white p-8 md:p-10 rounded-3xl shadow-xl border border-[#cdebea]">
            ...
            <form className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select className="w-full border border-[#cdebea] rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#1a504c]">
              ...
              <button
                type="submit"
                className="md:col-span-2 bg-[#1a504c] text-white py-4 rounded-xl font-semibold text-lg hover:bg-[#143d3a] transition duration-300"
              >
                Book Appointment
              </button>
