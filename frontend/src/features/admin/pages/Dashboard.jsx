...
const DashboardCharts = lazy(
  () => import("../courses/components/DashboardCharts")
);
      ...
      <Suspense
        fallback={
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-4 mt-6">
            <div className="xl:col-span-2 h-[360px] rounded-2xl bg-gray-100 animate-pulse" />

            <div className="h-[360px] rounded-2xl bg-gray-100 animate-pulse" />
          </div>
        }
      >
        <DashboardCharts />
