  ...
  return (
    <Link to="/" className="flex items-center gap-3 select-none">
      ...
      <div className="flex flex-col justify-center leading-none">
        ...
        {/* Title Container with relative positioning for TM */}
        <div className="relative inline-block pr-5">
          <h2
            className={`text-xl font-extrabold tracking-wide mb-1 transition-colors duration-300 ${
              scrolled ? "text-[#081A33]" : "text-white"
            }`}
          >
            Odisha
          ...
          {/* Circled TM Mark - Positioned strictly at the top right corner */}
          <span
            className={`absolute top-0 right-0 text-[6px] font-bold border rounded-full h-3 w-3 flex items-center justify-center tracking-tighter transition-colors duration-300 ${
